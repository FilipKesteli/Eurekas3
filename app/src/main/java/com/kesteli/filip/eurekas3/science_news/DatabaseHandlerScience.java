package com.kesteli.filip.eurekas3.science_news;
...
public class DatabaseHandlerScience extends SQLiteOpenHelper {
        ...
        public DatabaseHandlerScience(Context context) {
